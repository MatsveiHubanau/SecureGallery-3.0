...
class ViewController: UIViewController {
    ...
    @IBAction func unlock(_ sender: Any) {
        if pinField.text == "1234"{
            ...
            showAlert("Wrong PIN", message: "Try again")
    ...
    @IBAction func connectButton(_ sender: Any) {
        showContactSheet("Choose the way to contact", message: "")
    }
    ...
    func showContactSheet (_ title: String, message: String) {
        ...
        let callAction = UIAlertAction(title: "Make call",
                                       style: .default,
                                       handler: {(UIAlertAction) in
        ...
        let emailAction = UIAlertAction(title: "Send E-mail",
                                        style: .default,
                                        handler: {(UIAlertAction) in if MFMailComposeViewController.canSendMail() {
                                            ...
                                            mail.setMessageBody("<h>Describe your problem</h>", isHTML: true)
                                            mail.setCcRecipients(["tcook@apple.com"])
                                            self.present(mail, animated: true)
                                        }})
        let telegramAction = UIAlertAction(title: "Contact via Telegram",
                                           style: .default,
                                           handler: { (UIAlertAction) in
